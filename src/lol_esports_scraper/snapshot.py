...
def write_snapshot(db_path: str | Path, out_dir: str | Path) -> dict[str, Any]:
    from lol_esports_scraper.snapshot_io import write_snapshot_files
    ...
    return write_snapshot_files(
        ...
        extra_manifest={
            ...
            "id_stability_note": (
                "Not a public-site numeric id; stable if id stays stable_key hash, "
                "not across total schema rewrite."
            ),
        },
    )
